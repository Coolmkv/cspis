...
class AdminController extends Controller
{
    ...
    public function registeredStudentsData(){
        ...
        StudentRegistration::CATEGORY,
        StudentRegistration::DISTRICT,
        StudentRegistration::STATE,
        StudentRegistration::PINCODE,
        StudentRegistration::CONTACT_NUMBER,
        StudentRegistration::PASSING_BOARD,
        StudentRegistration::YEAR_OF_PASSING,
